...
const fileFilter = (req, file, callback) => {
    if (file.mimetype === "file/png" || "file/jpeg" || "file/jpg") {
        callback(null, true);
    } else {
...
export const uploadFiles = async (req, res, next) => {
    try {
        ...
        const fields = [
            { name: 'parents_Dec', maxCount: 1, folder: 'parent-declaration' },
            { name: 'students_Dec', maxCount: 1, folder: 'student-declaration' },
            { name: 'faculty_Rec', maxCount: 1, folder: 'faculty-recommendation' },
