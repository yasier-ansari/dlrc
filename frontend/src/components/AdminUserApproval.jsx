...
const AdminUserApprovalComp = ({ flag, id }) => {
	const { setModalPopped, userType, token, setUserInfo } =
...
'
						...
						<div className='w-full flex items-center text-white justify-between space-x-6 sm:space-x-8 md:space-x-12 mx-auto max-w-2xl  '>
							...
							>
								<p className='font-bold text-sm sm:text-base md:text-lg pl-4 rounded-lg py-2 px-3 sm:px-4 md:px-6 border-2 w-full bg-gradient-to-tr from-[#52b788] hover:scale-110 transition-all duration-300 ease-linear to-[#40916c]  '>
									Accept
								</p>
							</button>
							<button
							...
							>
								<p className='font-bold text-sm sm:text-base md:text-lg pl-4 rounded-lg py-2 px-3 sm:px-4 md:px-6 border-2 w-full bg-gradient-to-tr from-red-400 hover:scale-110 transition-all duration-300 ease-linear to-[#db3100]  '>
									Reject
								</p>
							</button>
						</div>
