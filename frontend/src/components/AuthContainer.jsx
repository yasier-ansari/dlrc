...
const AuthContainer = ({ children, action, actionText }) => {
    return (
        <div className=' flex flex-col relative max-w-[450px] items-center py-12 px-4 sm:px-6 md:px-12 flex-grow bg-white border-2 border-[#40916c] shadow-green-900/50  rounded-lg space-y-8 xl:space-y-10 '>
