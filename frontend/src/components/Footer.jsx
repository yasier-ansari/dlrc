...
const Footer = () => {
    return (
        <footer className="relative  font-bold pb-12 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20 mt-20  ">
            <div className="flex flex-col relative h-full max-w-6xl items items-stretch  w-full justify-center mx-auto gap-2  text-gray-800   ">
                ...
                <div className="w-full flex justify-between items-center " >
                    ...
                    <div className=" flex justify-end items-center " >
                        <div className="flex text-gray-500 items-center gap-12 text-xs md:text-sm "  >
                            {/* <p>Rules</p>
                            <p>FAQ</p>
                            <p>About</p> */}
                            <p className="flex " >Made with <TbDeviceDesktopHeart className="mx-2 w-5 h-5 md:w-6 md:h-6" /> by <span className="mx-2 font-[700]  text-[#40916c] italic  " >mubasshir</span> & <span className="mx-2 font-[700]  text-[#40916c] italic  " >yasier</span> </p>
                        </div>
                    </div>
                </div>
            </div>
