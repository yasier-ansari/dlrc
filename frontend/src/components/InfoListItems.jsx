...
const InfoListItems = ({ children, markerType }) => {
    ...
    return (
        <li className={cn(`marker flex items-center justify-start space-x-2 before:text-green-700 before:mr-2`)}>
            {getCyclicMarker()}
            <span>{children}</span>
        </li>
    );
