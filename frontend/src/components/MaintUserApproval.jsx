...
const MaintUserApprovalComp = ({ flag, id }) => {
    ...
    const laptop_options = [{ value: "3443jh4g32j4gj2h34", text: "Laptop L1", id: 1 }, { value: "3563jh4g32j4gj2h34", text: "Laptop L2", id: 2 }, { value: "3443jh4g32j4g88h34", text: " Laptop L3", id: 3 }]
    const [form, setForm] = useState({ reason: '', duration: '', laptop_id: '' });
    const [errors, setErrors] = useState({ reason: '', duration: '', laptop_id: '' });
    ...
    const validateForm = () => {
        ...
        if (!form?.laptop_id) {
            ...
            valid = false;
        } else if (!laptop_options.some(option => option.value === form?.laptop_id)) {
                    ...
                    <div className="flex items-center w-full justify-center mx-auto flex-col space-y-4 sm:space-y-6 md:space-y-8  max-w-6xl  mb-20" >
                        ...
                        <div className="w-full flex items-center justify-between space-x-6  " >
                            <div className="flex flex-col items-start justify-center space-y-2  w-full " >
                                ...
                                {errors.reason && <p className="text-[#db3100] text-start text-sm ml-2 font-bold ">{errors.reason}</p>}
                            </div>
                        </div>
                        {/* <div className="w-full flex items-center justify-between space-x-6  " >
                            <div className="flex flex-col items-start justify-center space-y-2 w-full">
                        ...
                        <div className="w-full flex items-center justify-between space-x-6  " >
                            <div className="flex flex-col items-start justify-center space-y-2 w-full">
                                ...
                                <select
                                    ...
                                    className="font-bold text-sm sm:text-base md:text-lg pl-4 rounded-lg py-2 px-3 sm:px-4 md:px-6 border-2 w-full h-auto bg-green-100/20 border-zinc-300 resize-none focus:outline-[#74c69d]  "
                                >
                                ...
                                {errors.duration && <p className="text-[#db3100] text-start text-sm ml-2 font-bold ">{errors.duration}</p>}
                            </div>
                            <div className="flex flex-col items-start justify-center space-y-2  w-full " >
                                <p className="bg-[#40916c] rounded-lg px-2 py-1 md:px-3 md:py-[5px] text-xs font-bold text-white" >Issued Laptop</p>
                                <select
                                    name="duration"
                                    required={true}
                                ...
                                {errors.laptop_id && <p className="text-[#db3100] text-start text-sm ml-2 font-bold ">{errors.laptop_id}</p>}
                            </div>
                        </div>
                        <div className="w-full flex items-center text-white justify-between space-x-6 sm:space-x-8 md:space-x-12 mx-auto max-w-2xl  " >
                            <button onClick={(e) => { SubmitHandler(e, "accept") }} className="flex flex-col items-start justify-center space-y-2  w-full " >
                                <p className="font-bold text-sm sm:text-base md:text-lg pl-4 rounded-lg py-2 px-3 sm:px-4 md:px-6 border-2 w-full bg-gradient-to-tr from-[#52b788] hover:scale-110 transition-all duration-300 ease-linear to-[#40916c]  "  >Accept</p>
                            </button>
