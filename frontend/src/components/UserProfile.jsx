...
const UserProfile = () => {
    ...
    const validateForm = () => {
        ...
        if (form?.idCard) {
            ...
            if (!form?.idCard) {
                newErrors.image = 'ID card is mandatory';
                valid = false;
            ...
            <div className="flex w-full items-center mx-auto flex-col space-y-4 max-w-6xl  pb-20" >
                ...
                <div className="w-full flex items-center justify-between space-x-6  " >
                    <div className="flex flex-col items-start justify-center space-y-2 basis-[60%] w-full " >
                        ...
                        <input value={form?.fullname} name="fullname" type="text" onChange={(e) => setForm({ ...form, fullname: e.target.value })} className="font-bold text-base md:text-lg pl-4 rounded-lg py-2 px-3 sm:px-4 md:px-6 border-2 w-full bg-green-100/20 border-zinc-300 " />
                        <p className="text-[#db3100] text-start text-xs ml-2 font-bold ">{errors?.fullname || '‎'}</p>
                    ...
                    <div className="flex items-start justify-center space-y-2 flex-col  basis-[40%] w-full " >
                        ...
                        <input
                            ...
                            className="font-bold text-base md:text-lg pl-4 rounded-lg py-2 px-3 sm:px-4 md:px-6 border-2 w-full bg-green-100/20 border-zinc-300 " />
                        <p className="text-[#db3100] text-start text-xs ml-2 font-bold ">{errors.domain_id || '‎'}</p>
                ...
                <div className="w-full flex items-center justify-between space-x-3 " >
                    <div className="flex basis-[30%] items-start justify-center space-y-2 flex-col " >
                        ...
                        <input
                            ...
                            className="  font-bold text-base md:text-lg pl-4 rounded-lg py-2 px-3 sm:px-4 md:px-6 border-2 w-full bg-green-100/20 border-zinc-300 " />
                        <p className="text-[#db3100] text-start text-xs ml-2 font-bold ">{errors.prn || '‎'}</p>
                    ...
                    <div className="flex basis-[30%] items-start justify-center space-y-2 flex-col " >
                        ...
                        <p className="text-[#db3100] text-start text-xs ml-2 font-bold ">{errors.department || '‎'}</p>
                    ...
                    <div className="flex basis-[20%] items-start justify-center space-y-2 flex-col " >
                        ...
                        <p className="text-[#db3100] text-start text-xs ml-2 font-bold ">{errors?.year || '‎'}</p>
                    </div>
                    <div className="flex basis-[20%]  items-start justify-center space-y-2 flex-col " >
                        ...
                        <p className="text-[#db3100] text-start text-xs ml-2 font-bold ">{errors?.sem || '‎'}</p>
                    </div>
                </div>
                <div className="w-full flex items-center justify-between space-x-6  " >
                    <div className="flex flex-col items-start justify-center space-y-2 w-full " >
                        <div className="flex items-start justify-start w-full h-full flex-col space-y-3 ">
                            ...
                            <p className="text-[#db3100] text-start text-xs ml-2 font-bold ">{errors?.idCard || '‎'}</p>
                        </div>
                    </div>
                </div >
