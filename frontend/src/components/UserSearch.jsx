...
const SearchInput = (props) => {
	...
	return (
		<>
			<form className='relative w-full py-2  lg:py-1 justify-center flex items-center rounded-md bg-slate-200 text-sm '>
				...
				<input
					...
					type='text'
					placeholder='Search...'
					className='  block w-full pl-10  outline-none md:pl-12  lg:pl-12 sm:py-1 md:py-2 h-full rounded-md bg-slate-200  '
				/>
			</form>
		</>
	)
				...
				<div className='flex text-xs md:text-base flex-col md:flex-row w-max mt-3 sm:mt-5 lg:mt-0 space-y-3 sm:space-y-5 justify-start items-center md:space-y-0 md:justify-end lg:space-x-12 last:space-x-6 '>
					<div className='flex items-center justify-center space-x-5  md:space-x-8 lg:space-x-3 text-sm'>
						...
						<select
							...
							value={''}
							className=' text-black bg-slate-200 rounded-md h-full w-full px-1 md:px-2 lg:px-3 py-1 md:py-2 outline-none '
						>
					...
					<div className='flex items-center justify-center space-x-5 md:space-x-8 lg:space-x-3 text-sm'>
						...
						<select
							...
							value={''}
							className=' bg-slate-200  text-black rounded-md h-full w-full px-1 md:px-2 lg:px-3 py-1 md:py-2 outline-none '
						>
							<option value='' disabled hidden>
								Select Sem
							</option>
