				...
				<MaxWidthWrapper className='flex-grow flex-1 px-6 sm:px-8 md:px-12 lg:px-20 xl:px-24 flex-col justify-center mx-auto items-center max-w-6xl w-full h-full '>
					...
					<div className='flex flex-col  w-full h-full  max-w-4xl mt-16 mb-20'>
						<div className='flex w-full h-full items-center mb-4 md:mb-6'>
							<h3 className=' w-max font-bold text-[#2d6a4f] text-2xl md:text-3xl pr-4 m-0 rounded-md md:self-start italic  '>
								Issuance
							</h3>
					...
					<div className='flex flex-col  w-full h-full  max-w-4xl mb-20'>
						<div className='flex w-full h-full items-center justify-between mb-4 md:mb-6'>
							<div className='w-full h-full bg-[#74c69d90] p-1 rounded-sm basis-[58%] '>
								‎
							</div>
							<h3 className='font-bold text-[#2d6a4f] text-2xl md:text-3xl ml-3 mr-0 rounded-md md:self-end flex w-full basis-[42%] italic '>
								Return
							</h3>
						</div>
					...
					<div className='flex flex-col  w-full h-full  max-w-4xl mb-20'>
						<div className='flex w-full h-full items-center mb-4 md:mb-6'>
							<h3 className=' w-max font-bold text-[#2d6a4f] text-2xl md:text-3xl pr-3 m-0 rounded-md md:self-start italic '>
								Website
							</h3>
							<div className='w-full h-full bg-[#74c69d90]  p-1 rounded-sm'>
								‎
